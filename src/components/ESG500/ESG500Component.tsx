    ...
    <>
      <div className="w-full p-5 md:p-20 flex flex-col items-center lg:items-start min-h-screen bg-no-repeat bg-cover bg-white overflow-hidden">
        <div className="w-3/5 flex flex-col max-w-[25rem] lg:max-w-none">
          ...
          <RightMotionComponent component={motion.div}>
            <Image
              src="/ESG500/Eclipse 1.png" // 이미지 경로
              alt="Eclipse1"
              width={1074} // 너비
              height={1050} // 높이
              // layout="fixed" // 레이아웃 옵션
        ...
        {/* 세번째 단락 */}
        <div className="w-full mt-36 lg:mt-72 flex flex-col items-center lg:items-start lg:px-32">
          <RightMotionComponent component={motion.div}>
            <Image
          ...
          <RightMotionComponent component={motion.h1} className="text-4xl font-normal my-16">
            지식, 윤리, 인재의 힘
          </RightMotionComponent>

          <RightMotionComponent component={motion.p} className="font-normal text-xl text-[#999999] leading-8 mb-28">
        ...
        <div className="w-full flex flex-col items-center ">
          <NoMotionComponent component={motion.div} className="flex flex-col items-center">
            <p className="font-bold text-2xl text-[#79ad4b] mb-3">인재 경영: 우리의 가장 큰 자산</p>
            <div className="w-96 h-60 bg-[#d9d9d9] rounded-3xl py-5 flex justify-center text-[#404040] mb-12">
              <div className="w-[70%] flex flex-col items-center text-base">
          ...
          <div className="flex flex-col md:flex-row gap-12">
            <RightMotionComponent component={motion.div} className="flex flex-col items-center">
              <p className="font-bold text-2xl text-[#79ad4b] mb-3">윤리경영: 신뢰의 기반</p>
            ...
            <LeftMotionComponent component={motion.div} className="flex flex-col items-center">
              <p className="font-bold text-2xl text-[#79ad4b] mb-3">지식경영: 끊임없는 혁신의 동력</p>
              <div className="w-96 h-60 bg-[#d9d9d9] rounded-3xl py-5 flex justify-center text-[#404040]">
                <div className="w-[80%] flex flex-col items-center">
